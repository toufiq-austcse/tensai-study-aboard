            ...
            <div className="container py-12">
                <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
                    <div className="md:col-span-4">
                        <p className="mb-6">
                            Opening doors to international education opportunities and helping students achieve their
                            academic dreams abroad.
                        </p>
                        <div className="flex space-x-4">
                            <a href="https://www.facebook.com/TensaiStudyAbroadBD" target="_blank"
                               rel="noopener noreferrer"
                               className="bg-[#004aad] hover:bg-[#003b8e] p-2 rounded-full transition-colors">
                                <Facebook size={20}/>
                            </a>
                            <a href="https://www.instagram.com/tensaistudyabroad/" target="_blank"
                               rel="noopener noreferrer"
                               className="bg-[#004aad] hover:bg-[#003b8e] p-2 rounded-full transition-colors">
                                <Instagram size={20}/>
                            </a>
                            <a href="https://www.linkedin.com/company/tensai-study-abroad/" target="_blank"
                               rel="noopener noreferrer"
                               className="bg-[#004aad] hover:bg-[#003b8e] p-2 rounded-full transition-colors">
                                <Linkedin size={20}/>
                            </a>
                    ...
                    <div className="md:col-span-2">
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><a href="#destinations" className="hover:text-white transition-colors">Destinations</a>
                            </li>
